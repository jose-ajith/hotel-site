...
export default function About() {
  ...
  minHeight: "100vh",
    ...
    <div className="pages">
      ...
      <div className="story">
      <p>In 1984, a young chef named Daniel Mercer and his wife Elena opened a tiny neighborhood restaurant called Opus Cutlery in a renovated corner building near the city’s old train district. At the time, the area was mostly warehouses and small repair shops, and many people thought opening a restaurant there was a bad idea.</p>
      ...
      <p>What made Opus Cutlery different in the 1980s was its unusual mix of modern presentation and comforting recipes. While many restaurants focused on heavy classic dishes, they served lighter seasonal meals, homemade bread, wood-fired vegetables, and fresh seafood with simple flavors. Word slowly spread through the city.</p>
